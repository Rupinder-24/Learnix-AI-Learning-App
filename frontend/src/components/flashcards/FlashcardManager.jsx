...
const FlashcardManager = ({ documentId }) => {
    ...
    const handleToggleStar=async(cardId)=>{
        try {
            ...
            toast.success("Flashcard starred status update!");
        ...
        >
            <div className='space-y-6'>
                ...
                <div className='flex items-center justify-end gap-3 pt-2'>
                    ...
                    disabled={deleting}
                    className='px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl trasition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed '
                    >
                        Cancel
