    ...
    <div className='relative w-full h-72' style={{perspective:'1000px'}}>
      ...
      >
        ...
        {/* Back of the card(Answer) */}
         <div
        className='absolute inset-0 w-full h-full bg-linear-to-br from-emerald-500 to-teal-500 border-2 border-emerald-400/60 rounded-2xl shadow-xl shadow-emerald-500/25 p-8 flex flex-col justify-between' 
        style={{
          backfaceVisibility:'hidden',
          WebkitBackfaceVisibility:'hidden',
        ...
        >
          ...
          <div className='flex justify-end'>
            ...
            className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 ${
              ...
              :'bg-white/20 backdrop-blur-sm text-white/70 border hover:bg-white/30 hover:text-white border-white/20'
            }`}
            >
              <Star
              className='w-4 h-4'
