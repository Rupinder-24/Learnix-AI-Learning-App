    ...
    <div className='max-w-5xl mx-auto'>
      ...
      <div className='bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-8 '>
        <div className='text-center space-y-6'>
          <div className='inline-flex items-center justify-center w-15 h-15 rounded-2xl bg-linear-to-br from-emerald-500 to-teal-100 shadow-lg shadow-emerald-500/25'>
      ...
      <div className='space-y-6'>
        <div className='flex items-center gap-3 mb-2'>
          ...
          <h3 className='text-lg font-semibold text-slate-900'>Delailed Review</h3>
        ...
        {detailedResults.map((result, index) => {
          ...
          // const correctAnswerIndex = result.correctAnswer.startsWith('')
              ...
              <div className='flex items-start justify-between gap-4 mb-3'>
                <div className='flex-1'>
                  <div className='inline-flex items-center gap-2 px-3 py-1 bg-slate-50 border border-slate-200 rounded-lg mb-3'>
                    <span className='text-xs font-sembold text-slate-600'>
                      Question {index + 1}
